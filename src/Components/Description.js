    ...
    render() {
        ...
        return (
            <View style={{ padding: "3%" }}>
                ...
                <Text style={{ marginTop: "2%",fontSize:13 }}>The restaurent has an extensive selection of fresh fish flown in daily from the sea of Japan as well as both the atlantic an pacific oceans.</Text>
            </View>
        )
    }
}
